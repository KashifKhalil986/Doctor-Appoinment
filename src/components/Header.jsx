...
<div className="flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light ">
    ...
    <a className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-sm m-auto md:m-0 text-gray-600 hover:scale-105 transition-all duration-300' href="">
