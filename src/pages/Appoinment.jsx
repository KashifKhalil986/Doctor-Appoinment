...
<div className="flex gap-3 items-center w-full overflow-x-auto mt-4">
 {  docSlots?.map((item,index) => (
    <div onClick={()=>setSlotIndex(index)} className={`text-center py-6 min-w-16 rounded-full cursor-pointer border border-gray-200  ${slotIndex=== index ? 'bg-[#5f6FFF] text-white ' : "" }`}>
